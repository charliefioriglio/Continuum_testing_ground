...
from radial_annie import compute_radial_function
from phi import compute_Phi_m
from scipy.special import lpmv

def build_single_mode_wavefunction_on_xyz_grid(m, n, E, a, D, X, Y, Z, L_max=20.0, R_max=20.0, xi_vals=None, eta_vals=None, phi_vals=None):
    ...
    S_xi_vals = compute_radial_function(m, n, eigvals_ang, c, R_max, xi_vals)
